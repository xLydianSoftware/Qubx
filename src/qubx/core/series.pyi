...
class TimeSeries:
    ...
    def __lt__(self, other: Union[TimeSeries, float, int]) -> "TimeSeries": ...
    def __le__(self, other: Union[TimeSeries, float, int]) -> "TimeSeries": ...
    def __gt__(self, other: Union[TimeSeries, float, int]) -> "TimeSeries": ...
    def __ge__(self, other: Union[TimeSeries, float, int]) -> "TimeSeries": ...
    def __eq__(self, other: Union[TimeSeries, float, int]) -> "TimeSeries": ...
    def __ne__(self, other: Union[TimeSeries, float, int]) -> "TimeSeries": ...
    ...
    def clone(self) -> "TimeSeries": ...
    def shift(self, period: int) -> "TimeSeries": ...
    def diff(self, period: int = 1) -> "TimeSeries": ...
    def resample(self, timeframe: str, max_series_length=np.inf, process_every_update=True) -> "TimeSeries": ...
