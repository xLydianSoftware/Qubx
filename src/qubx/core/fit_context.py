...
class FitContext(ITimeProvider):
    ...
    set_deny_trading_when_degraded = _denied("set_deny_trading_when_degraded", "an on_init-time setting")
...
_PASSTHROUGH_READS: tuple[str, ...] = (
    ...
    "auto_subscribe",
    "get_event_schedule",
    "has_handler",  # dict membership read on the ProcessingManager — safe from any thread
    "is_fitted",
