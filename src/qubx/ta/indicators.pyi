...
def rma(series: TimeSeries, period: int) -> Indicator: ...
...
def super_trend(
    series: OHLCV, length: int = 22, mult: float = 3.0, src: str = "hl2", wicks: bool = True, atr_smoother: str = "sma"
) -> Indicator: ...
def vwma(ohlc: OHLCV, period: int = 20, price_source: str = "close") -> IndicatorOHLC: ...
def stochastic(series: OHLCV, period: int = 14, smooth_period: int = 3, smoother: str = "sma") -> "Stochastic": ...
def adx(series: OHLCV, period: int = 14, smoother: str = "sma") -> "Adx": ...
def fdi(series: TimeSeries, period: int = 30) -> Indicator: ...
def wma(series: TimeSeries, period: int) -> "Wma": ...
def hma(series: TimeSeries, period: int) -> "Hma": ...
def mcginley(series: TimeSeries, period: int) -> "Mcginley": ...
...
class SuperTrend(IndicatorOHLC):
    ...
    atr_smoother: str
    def __init__(
        self, name: str, series: OHLCV, length: int, mult: float, src: str, wicks: bool, atr_smoother: str
    ): ...

class Stochastic(IndicatorOHLC):
    d: TimeSeries
    period: int
    smooth_period: int
    smoother: str
    def __init__(self, name: str, series: OHLCV, period: int, smooth_period: int, smoother: str): ...

class Adx(IndicatorOHLC):
    dip: TimeSeries
    dim: TimeSeries
    period: int
    smoother: str
    def __init__(self, name: str, series: OHLCV, period: int, smoother: str): ...
