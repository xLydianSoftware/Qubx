class NoDataContinue:
    ...
    def __init__(self, next_scheduled_time: int | None = None):
        """
        Initialize the sentinel.

        Args:
            next_scheduled_time: The next scheduled event time in nanoseconds, or None if no scheduled events exist.
        """
