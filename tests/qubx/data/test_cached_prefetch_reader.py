...
from qubx.data.readers import AsPandasFrame, DataReader, DataTransformer
...
class TestCachedPrefetchReader:
    ...
    def test_get_aux_data_passthrough(self):
        ...
        mock_reader.get_aux_data.assert_called_once_with(
            "candles", exchange="BINANCE.UM", symbols=["BTCUSDT"], timeframe="1d"
        )
    ...
    def test_aux_data_multiindex_timestamp_filtering(self):
        ...
        test_data = pd.DataFrame(
            {"price": range(len(multi_index)), "volume": range(100, 100 + len(multi_index))}, index=multi_index
        )
        ...
        result = reader.get_aux_data(
            "candles", exchange="BINANCE.UM", symbols=["BTCUSDT", "ETHUSDT"], start="2023-01-03", stop="2023-01-06"
        )
        ...
        result_start_only = reader.get_aux_data(
            "candles", exchange="BINANCE.UM", symbols=["BTCUSDT", "ETHUSDT"], start="2023-01-07"
        )
        ...
        result_stop_only = reader.get_aux_data(
            "candles", exchange="BINANCE.UM", symbols=["BTCUSDT", "ETHUSDT"], stop="2023-01-04"
        )
    ...
    def test_symbol_filtering_all_symbols_to_specific_symbols(self):
        ...
        result1 = reader.get_aux_data("candles", exchange="BINANCE.UM", start="2023-01-01", stop="2023-01-05")
        ...
        result2 = reader.get_aux_data(
            "candles", exchange="BINANCE.UM", symbols=["BTCUSDT", "ETHUSDT"], start="2023-01-02", stop="2023-01-04"
        )
        ...
        result3 = reader.get_aux_data(
            "candles", exchange="BINANCE.UM", symbols=["LTCUSDT"], start="2023-01-01", stop="2023-01-03"
        )
    ...
    def test_symbol_filtering_specific_symbols_to_all_symbols(self):
        ...
        result2 = reader.get_aux_data("candles", exchange="BINANCE.UM", start="2023-01-01", stop="2023-01-05")
    ...
    def test_symbol_filtering_non_multiindex_data(self):
        ...
        timestamps = pd.date_range("2023-01-01", "2023-01-05", freq="D")
        test_data = pd.DataFrame(
            {"price": range(len(timestamps)), "volume": range(100, 100 + len(timestamps))}, index=timestamps
        )
        ...
        reader.get_aux_data(
            "candles", exchange="BINANCE.UM", symbols=["BTCUSDT"], start="2023-01-02", stop="2023-01-04"
        )
        assert reader._cache_stats["misses"] == 2  # Should be cache miss
        assert reader._cache_stats["hits"] == 0
    ...
    def test_symbol_filtering_with_time_range_filtering(self):
        ...
        result1 = reader.get_aux_data("candles", exchange="BINANCE.UM", start="2023-01-01", stop="2023-01-20")
        assert len(result1) == 60  # 20 days * 3 symbols
        assert reader._cache_stats["misses"] == 1

        # Second request: specific symbols and smaller time range (should be cache hit)
        result2 = reader.get_aux_data(
            "candles", exchange="BINANCE.UM", symbols=["BTCUSDT", "ETHUSDT"], start="2023-01-05", stop="2023-01-10"
        )
    ...
    def test_prefetch_aux_data_with_existing_cache(self):
        ...
        results1 = reader.prefetch_aux_data(
            ["candles"], start="2023-01-01", stop="2023-01-10", exchange="BINANCE.UM", symbols=["BTCUSDT", "ETHUSDT"]
        )
        ...
        results2 = reader.prefetch_aux_data(
            ["candles"], start="2023-01-02", stop="2023-01-08", exchange="BINANCE.UM", symbols=["BTCUSDT"]
        )
    ...
    def test_prefetch_aux_data_error_handling(self):
        ...
        results = reader.prefetch_aux_data(
            ["candles", "funding", "nonexistent"], start="2023-01-01", stop="2023-01-10", exchange="BINANCE.UM"
        )
    ...
    def test_prefetch_aux_data_optional_parameters(self):
        ...
        results = reader.prefetch_aux_data(["candles"], start="2023-01-01", stop="2023-01-10")
    ...
    def test_prefetch_aux_data_empty_list(self):
        ...
        results = reader.prefetch_aux_data([], start="2023-01-01", stop="2023-01-10")
    ...
    def test_read_basic_caching(self):
        ...
        # First read request
        result1 = reader.read(
            "BINANCE.UM:BTCUSDT", start="2023-01-01", stop="2023-01-03", data_type="candles", chunksize=0
        )
    ...
    def test_read_chunked_iteration(self):
        ...
        result_iterator = reader.read(
            "BINANCE.UM:BTCUSDT", start="2023-01-01", stop="2023-01-04", data_type="candles", chunksize=2
        )
    ...
    def test_read_aux_data_overlap(self):
        ...
        reader.get_aux_data("candles", exchange="BINANCE.UM", start="2023-01-01", stop="2023-01-05")
    ...
    def test_read_multi_period_caching(self):
        ...
        result2 = reader.read(
            "BINANCE.UM:BTCUSDT", start="2023-01-03", stop="2023-01-04", data_type="candles", chunksize=0
        )
        ...
        result3 = reader.read(
            "BINANCE.UM:BTCUSDT", start="2023-01-01", stop="2023-01-04", data_type="candles", chunksize=0
        )
    ...
    def test_read_cache_infrastructure(self):
        ...
        reader.read("BINANCE.UM:BTCUSDT", start="2023-01-01", stop="2023-01-02", data_type="candles", chunksize=0)
    ...
    def test_read_aux_data_overlap_with_symbol_filtering(self):
        ...
        reader.get_aux_data("funding_payment", exchange="BINANCE.UM", start="2023-01-01", stop="2023-01-03")
    ...
    def test_read_aux_data_overlap_with_missing_symbol(self):
        ...
        reader.get_aux_data("funding_payment", exchange="BINANCE.UM", start="2023-01-01", stop="2023-01-02")
    ...
    def test_read_aux_data_overlap_with_multiindex_symbol_filtering(self):
        ...
        aux_data = pd.DataFrame(
            {"funding_rate": [0.0001, 0.0002, 0.0003, 0.0004, 0.0005, 0.0006], "interval_hours": [8, 8, 8, 8, 8, 8]},
            index=index,
        )
