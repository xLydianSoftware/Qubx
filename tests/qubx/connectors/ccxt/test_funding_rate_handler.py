...
def mock_exchange():
    ...
    exchange.market = Mock(return_value={
        "symbol": "BTCUSDT",
        "type": "swap",
        "linear": True,
        "base": "BTC",
...
class TestSimplifiedFundingHandler:
    ...
    def test_both_subscription_types_work_independently(self, funding_handler, btc_instrument, rate_channel, payment_channel):
    ...
    async def test_subscriber_always_emits_funding_rates(self, mock_convert, mock_find_instrument, funding_handler, btc_instrument, rate_channel):
        ...
        funding_handler._exchange.watch_funding_rates.return_value = {
            "BTCUSDT": {"some": "data"}
        }
    ...
    @patch('qubx.connectors.ccxt.handlers.funding_rate.ccxt_find_instrument')
    @patch('qubx.connectors.ccxt.handlers.funding_rate.ccxt_convert_funding_rate')
    async def test_subscriber_emits_payments_when_interval_changes(self, mock_convert, mock_find_instrument, funding_handler, btc_instrument, rate_channel):
